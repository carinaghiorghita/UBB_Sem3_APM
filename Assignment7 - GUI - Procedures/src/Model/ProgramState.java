...
public class ProgramState {
    ...
    private IProcedureTable procTable;

    public ProgramState(IStack<IStmt> stk, IStack<IDict<String,IValue>> symtbl,IDict<StringValue, BufferedReader> file,
                        IHeap<IValue> heap, IList<IValue> out, IStmt prg,int newID,IProcedureTable pt){
        exeStack=stk;
        symTable=symtbl;
        fileTable=file;
        heapTable=heap;
    ...
    public IStack<IDict<String, IValue>> getSymTable() {
        return symTable;
    }
    ...
    public IDict<String, IValue> getCurrentSymTable() throws StackException{return symTable.pop();}

    public IProcedureTable getProcTable() {
        return procTable;
    }
