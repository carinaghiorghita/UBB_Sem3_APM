...
public class ProgramRunController implements Initializable {
    ...
    private void loadData(){
        ...
        if(selectedProgram!=null){
            ...
            IHeap<Pair<Integer, List<Integer>>> semaphoreTable = selectedProgram.getSemTable();
            List<Map.Entry<Integer, Pair<Integer, List<Integer>>>> semaphoreList = new ArrayList<>();

            for (Map.Entry<Integer, Pair<Integer, List<Integer>>> entry : semaphoreTable.getHeap().entrySet())
